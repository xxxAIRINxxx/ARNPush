...
// ARNPush
#define COCOAPODS_POD_AVAILABLE_ARNPush
#define COCOAPODS_VERSION_MAJOR_ARNPush 0
#define COCOAPODS_VERSION_MINOR_ARNPush 1
#define COCOAPODS_VERSION_PATCH_ARNPush 0
